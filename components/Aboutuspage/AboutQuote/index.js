...
const AboutVQuote = () => {
    ...
    return (
        <div className='relative w-full  '>
            <Image src={Quote_bg} className='object-contain fixed -z-30 bg-fixed  top-0 right-0 w-full  ' alt='Quote-bg'/>
            <div className="containte-kh py-6 md:py-8 lg:py-10 z-10 ">
