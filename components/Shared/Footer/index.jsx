...
import bgimage from './../../../assect/img/footer-bg.jpg'

const Footer = () => {
    return (
        <div className={` bg-[url("https://templates.envytheme.com/ketan/default/assets/img/footer-bg.jpg")] center bg-cover bg-no-repeat relative z-10 bg-fixed before:bg-black before:absolute before:w-full before:h-full before:top-0 before:left-0 before:opacity-[.9] before:-z-10`}>
