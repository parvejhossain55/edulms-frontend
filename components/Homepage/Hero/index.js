            ...
            <div className="bg-[#e7ddf4]">
                <div className="containte-kh px-4  ">
                    <div className="hidden lg:block lg:pb-8">
                        <Image src={banner_1} className='moving-banner left-6 top-32 ' alt="banner" />
                        <Image src={banner_2} className='moving-banner left-2/4 top-32' alt="banner" />
                    </div>
                    ...
                    <div className="relative  ">
                        <Image src={banner_3} className='moving-banner -left-20 -top-40 ' alt=""/>
                        <Image src={banner_4} className='moving-banner left-2/4 -top-16' alt=""/>
                    </div>
