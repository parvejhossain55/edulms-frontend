            ...
            <div className="containte-kh px-4 py-8 sm:py-10 md:py-12 lg:py-16">
                ...
                <div className="flex flex-col justify-start md:flex-wrap md:flex-row gap-y-7 mt-10">
                    ...
                    <div className="flex justify-start items-start basis-full md:basis-6/12 lg:basis-4/12 activity-box transition-all">
                        <div className='border-[1px] border-rad-kh rounded-full mr-8  '>
                            <strong className='flex justify-center items-center text-3xl bg-[#ea512e] text-[#1b0238] w-16 h-16 rounded-full border-spacing-6 border-[5px] border-white p-8 l  transition ease-in duration-200  '>
                                01
                            </strong>
                        </div>
                        <div className='flex flex-col justify-start gap-y-4  '>
                            ...
                            <Link href='#' className='text-rad-kh text-md font-medium readMore-kh transition  transition-all ease-in duration-200'>Read More</Link>
                        </div>
                    </div>
                    ...
                    <div className="flex justify-start items-start basis-full md:basis-6/12 lg:basis-4/12 activity-box transition-all">
                        <div className='border-[1px] border-rad-kh rounded-full mr-8  '>
                            <strong className='flex justify-center items-center text-3xl bg-[#fdbea8] text-[#1b0238] w-16 h-16 rounded-full border-spacing-6 border-[5px] border-white p-8 l  transition ease-in duration-200  '>
                                02
                            </strong>
                        </div>
                        <div className='flex flex-col justify-start gap-y-4  '>
                    ...
                    <div className="flex justify-start items-start basis-full md:basis-6/12 lg:basis-4/12 activity-box transition-all">
                        <div className='border-[1px] border-rad-kh rounded-full mr-8  '>
                            <strong className='flex justify-center items-center text-3xl bg-[#b6fdd6] text-[#1b0238] w-16 h-16 rounded-full border-spacing-6 border-[5px] border-white p-8 l  transition ease-in duration-200  '>
                                03
                            </strong>
                        </div>
                        <div className='flex flex-col justify-start gap-y-4  '>
                    ...
                    <div className="flex justify-start items-start basis-full md:basis-6/12 lg:basis-4/12 activity-box transition-all">
                        <div className='border-[1px] border-rad-kh rounded-full mr-8  '>
                            <strong className='flex justify-center items-center text-3xl bg-[#fd91a8] text-[#1b0238] w-16 h-16 rounded-full border-spacing-6 border-[5px] border-white p-8 l  transition ease-in duration-200  '>
                                04
                            </strong>
                        </div>
                        <div className='flex flex-col justify-start gap-y-4  '>
                    ...
                    <div className="flex justify-start items-start basis-full md:basis-6/12 lg:basis-4/12 activity-box transition-all">
                        <div className='border-[1px] border-rad-kh rounded-full mr-8  '>
                            <strong className='flex justify-center items-center text-3xl bg-[#fce0ad] text-[#1b0238] w-16 h-16 rounded-full border-spacing-6 border-[5px] border-white p-8 l  transition ease-in duration-200  '>
                                05
                            </strong>
                        </div>
                        <div className='flex flex-col justify-start gap-y-4  '>
                    ...
                    <div className="flex justify-start items-start basis-full md:basis-6/12 lg:basis-4/12 activity-box transition-all">
                        <div className='border-[1px] border-rad-kh rounded-full mr-8  '>
                            <strong className='flex justify-center items-center text-3xl bg-[#cca0fe] text-[#1b0238] w-16 h-16 rounded-full border-spacing-6 border-[5px] border-white p-8 l  transition ease-in duration-200  '>
                                06
                            </strong>
                        </div>
                        <div className='flex flex-col justify-start gap-y-4  '>
